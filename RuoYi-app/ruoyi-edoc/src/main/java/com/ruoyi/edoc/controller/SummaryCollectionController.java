 ...
 */
@Controller
@RequestMapping("/edoc/summarycollection")
public class SummaryCollectionController extends BaseController
{
    private String prefix = "edoc/summarycollection";
    ...
    public String ReturnJsonInfo(@PathVariable("bill_uid") Long uid, ModelMap mmap)
    {
        ...
        return prefix + "/summaryCollection";
    }
    ...
    public AjaxResult analyzer(@PathVariable("bill_uid") Long uid)
    {
        ...
        try{
            ...
            return error("后台分析任务出现问题，请联系管理员");
        }
    }
